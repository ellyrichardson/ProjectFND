...
class IntervalAvailabilitiesCheckingOperationsTest: XCTestCase {
    ...
    func testGetLongestAvailableConsecutiveTimeSlotsForDay() {
        ...
        var longestTimeSlots = intervalAvailabilitiesHelper.getLongestAvailableConsecutiveTimeSlot(timeSlotDictionary: otherDict, dayToCheck: formatter.date(from: "2020/01/15")!)
        XCTAssert((longestTimeSlots["0-A"] == nil))
        XCTAssert((longestTimeSlots["0-B"] == nil))
        XCTAssert((longestTimeSlots["0-C"] == nil))
        XCTAssert((longestTimeSlots["0-D"] == nil))
        XCTAssert((longestTimeSlots["1-A"] == nil))
        XCTAssert((longestTimeSlots["1-B"] == nil))
        XCTAssert((longestTimeSlots["1-C"] == nil))
        XCTAssert((longestTimeSlots["1-D"] == nil))
        XCTAssert((longestTimeSlots["2-A"] == nil))
        XCTAssert((longestTimeSlots["2-B"] == nil))
        XCTAssert((longestTimeSlots["2-C"] == nil))
        XCTAssert((longestTimeSlots["2-D"] == nil))
        XCTAssert((longestTimeSlots["3-A"] == nil))
        XCTAssert((longestTimeSlots["3-B"] == nil))
        XCTAssert((longestTimeSlots["3-C"] == nil))
        XCTAssert((longestTimeSlots["3-D"] == nil))
        XCTAssert((longestTimeSlots["4-A"] == nil))
        XCTAssert((longestTimeSlots["4-B"] == nil))
        XCTAssert((longestTimeSlots["4-C"] == nil))
        XCTAssert((longestTimeSlots["4-D"] == nil))
        XCTAssert((longestTimeSlots["5-A"] == nil))
        XCTAssert((longestTimeSlots["5-B"] == nil))
        XCTAssert((longestTimeSlots["5-C"] == nil))
        XCTAssert((longestTimeSlots["5-D"] == nil))
        XCTAssert((longestTimeSlots["6-A"] == nil))
        XCTAssert((longestTimeSlots["6-B"] == nil))
        XCTAssert((longestTimeSlots["6-C"] == nil))
        XCTAssert((longestTimeSlots["6-D"] == nil))
        XCTAssert((longestTimeSlots["7-A"] != nil))
        XCTAssert((longestTimeSlots["7-B"] != nil))
        XCTAssert((longestTimeSlots["7-C"] != nil))
        XCTAssert((longestTimeSlots["7-D"] != nil))
        XCTAssert((longestTimeSlots["8-A"] != nil))
        XCTAssert((longestTimeSlots["8-B"] != nil))
        XCTAssert((longestTimeSlots["8-C"] != nil))
        XCTAssert((longestTimeSlots["8-D"] != nil))
        XCTAssert((longestTimeSlots["9-A"] != nil))
        XCTAssert((longestTimeSlots["9-B"] != nil))
        XCTAssert((longestTimeSlots["9-C"] != nil))
        XCTAssert((longestTimeSlots["9-D"] != nil))
        XCTAssert((longestTimeSlots["10-A"] != nil))
        XCTAssert((longestTimeSlots["10-B"] != nil))
        XCTAssert((longestTimeSlots["10-C"] != nil))
        XCTAssert((longestTimeSlots["10-D"] != nil))
        XCTAssert((longestTimeSlots["11-A"] != nil))
        XCTAssert((longestTimeSlots["11-B"] != nil))
        XCTAssert((longestTimeSlots["11-C"] != nil))
        XCTAssert((longestTimeSlots["11-D"] != nil))
        XCTAssert((longestTimeSlots["12-A"] != nil))
        XCTAssert((longestTimeSlots["12-B"] != nil))
        XCTAssert((longestTimeSlots["12-C"] != nil))
        XCTAssert((longestTimeSlots["12-D"] != nil))
        XCTAssert((longestTimeSlots["13-A"] != nil))
        XCTAssert((longestTimeSlots["13-B"] != nil))
        XCTAssert((longestTimeSlots["13-C"] == nil))
        XCTAssert((longestTimeSlots["13-D"] == nil))
        XCTAssert((longestTimeSlots["14-A"] == nil))
        XCTAssert((longestTimeSlots["14-B"] == nil))
        XCTAssert((longestTimeSlots["14-C"] == nil))
        XCTAssert((longestTimeSlots["14-D"] == nil))
        XCTAssert((longestTimeSlots["15-A"] == nil))
        XCTAssert((longestTimeSlots["15-B"] == nil))
        XCTAssert((longestTimeSlots["15-C"] == nil))
        XCTAssert((longestTimeSlots["15-D"] == nil))
        XCTAssert((longestTimeSlots["16-A"] == nil))
        XCTAssert((longestTimeSlots["16-B"] == nil))
        XCTAssert((longestTimeSlots["16-C"] == nil))
        XCTAssert((longestTimeSlots["16-D"] == nil))
        XCTAssert((longestTimeSlots["17-A"] == nil))
        XCTAssert((longestTimeSlots["17-B"] == nil))
        XCTAssert((longestTimeSlots["17-C"] == nil))
        XCTAssert((longestTimeSlots["17-D"] == nil))
        XCTAssert((longestTimeSlots["18-A"] == nil))
        XCTAssert((longestTimeSlots["18-B"] == nil))
        XCTAssert((longestTimeSlots["18-C"] == nil))
        XCTAssert((longestTimeSlots["18-D"] == nil))
        XCTAssert((longestTimeSlots["19-A"] == nil))
        XCTAssert((longestTimeSlots["19-B"] == nil))
        XCTAssert((longestTimeSlots["19-C"] == nil))
        XCTAssert((longestTimeSlots["19-D"] == nil))
        XCTAssert((longestTimeSlots["20-A"] == nil))
        XCTAssert((longestTimeSlots["20-B"] == nil))
        XCTAssert((longestTimeSlots["20-C"] == nil))
        XCTAssert((longestTimeSlots["20-D"] == nil))
        XCTAssert((longestTimeSlots["21-A"] == nil))
        XCTAssert((longestTimeSlots["21-B"] == nil))
        XCTAssert((longestTimeSlots["21-C"] == nil))
        XCTAssert((longestTimeSlots["21-D"] == nil))
        XCTAssert((longestTimeSlots["22-A"] == nil))
        XCTAssert((longestTimeSlots["22-B"] == nil))
        XCTAssert((longestTimeSlots["22-C"] == nil))
        XCTAssert((longestTimeSlots["22-D"] == nil))
        XCTAssert((longestTimeSlots["23-A"] == nil))
        XCTAssert((longestTimeSlots["23-B"] == nil))
        XCTAssert((longestTimeSlots["23-C"] == nil))
        XCTAssert((longestTimeSlots["23-D"] == nil))
        let emptyDict = [String: TimeSlot]()
        longestTimeSlots = intervalAvailabilitiesHelper.getLongestAvailableConsecutiveTimeSlot(timeSlotDictionary: emptyDict, dayToCheck: formatter.date(from: "2020/01/15")!)
        XCTAssert((longestTimeSlots["0-A"] != nil))
        XCTAssert((longestTimeSlots["0-B"] != nil))
        XCTAssert((longestTimeSlots["0-C"] != nil))
        XCTAssert((longestTimeSlots["0-D"] != nil))
